  ...
  <style type="text/css">
    ...
    <div class="d-flex justify-content-center">
                  <div style="width: 50%;">
                    ...
                    <div class="form-group">
                      <button class="col btn btn-primary">Cập nhật</button>
                    </div>
                    </form>
                  </div>
                </div>
